...
Source0  : https://files.pythonhosted.org/packages/d4/de/983fb0275c7361345b0b4916f88048cae9ce38aa8e6099af2e990d61e304/hatchling-1.17.0.tar.gz
...
%prep
%setup -q -n hatchling-1.17.0
cd %{_builddir}/hatchling-1.17.0
pushd ..
cp -a hatchling-1.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683903548
