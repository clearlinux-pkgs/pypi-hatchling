...
Source0  : https://files.pythonhosted.org/packages/2c/bb/d157db8ddefd82ea2fdf9cfd07affb3cdb945f50716432c26d71c8ecae09/hatchling-0.25.0.tar.gz
...
%prep
%setup -q -n hatchling-0.25.0
cd %{_builddir}/hatchling-0.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652681976
...
cp %{_builddir}/hatchling-0.25.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
