...
Source0  : https://files.pythonhosted.org/packages/cb/e2/889c7d8694a7e187209aa1cb6284640569c17324a34144dd2d905d5bda0f/hatchling-0.20.1.tar.gz
...
%prep
%setup -q -n hatchling-0.20.1
cd %{_builddir}/hatchling-0.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647299520
...
cp %{_builddir}/hatchling-0.20.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
