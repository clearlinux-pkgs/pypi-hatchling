...
%prep
%setup -q -n hatchling-1.3.1
cd %{_builddir}/hatchling-1.3.1
pushd ..
cp -a hatchling-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654006511
...
cp %{_builddir}/hatchling-1.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
