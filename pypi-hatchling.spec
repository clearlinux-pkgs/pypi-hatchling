...
Source0  : https://files.pythonhosted.org/packages/fd/4a/8196e79c0d6e5eb10436dd2fcccc889a76af6ecf9bc35f87408159497d4d/hatchling-1.21.0.tar.gz
...
%prep
%setup -q -n hatchling-1.21.0
cd %{_builddir}/hatchling-1.21.0
pushd ..
cp -a hatchling-1.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702926668
