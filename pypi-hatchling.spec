...
Source0  : https://files.pythonhosted.org/packages/de/a6/aea15316c8dc1ec0fc8a0fe622ddc81feb162677005847e7f7db30d36364/hatchling-1.16.1.tar.gz
...
%prep
%setup -q -n hatchling-1.16.1
cd %{_builddir}/hatchling-1.16.1
pushd ..
cp -a hatchling-1.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683844183
