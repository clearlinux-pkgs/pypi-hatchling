...
Source0  : https://files.pythonhosted.org/packages/1d/20/114862141f3bc69e01884fd225600b0ca178b2dfd6fd84f100e06bf199ab/hatchling-1.22.5.tar.gz
...
%prep
%setup -q -n hatchling-1.22.5
cd %{_builddir}/hatchling-1.22.5
pushd ..
cp -a hatchling-1.22.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712326172
