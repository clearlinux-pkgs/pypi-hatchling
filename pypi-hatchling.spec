...
Source0  : https://files.pythonhosted.org/packages/a4/06/ee62ad5ae37dbe2ced595cd2f514406cf66161d619de1d6cd565b6a53249/hatchling-1.12.1.tar.gz
...
%prep
%setup -q -n hatchling-1.12.1
cd %{_builddir}/hatchling-1.12.1
pushd ..
cp -a hatchling-1.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672688314
