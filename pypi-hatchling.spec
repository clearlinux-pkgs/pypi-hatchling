...
Source0  : https://files.pythonhosted.org/packages/cc/ea/b20914d39d99fa57166777406d5ce348b7249eb3f76cbcd8f2dae229b1d5/hatchling-1.11.0.tar.gz
...
%prep
%setup -q -n hatchling-1.11.0
cd %{_builddir}/hatchling-1.11.0
pushd ..
cp -a hatchling-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665419082
