...
Source0  : https://files.pythonhosted.org/packages/25/93/f925c1484984bbe921cefcfa25aea6dda96d88844cdfab3a2d5d182637bd/hatchling-0.24.0.tar.gz
...
%prep
%setup -q -n hatchling-0.24.0
cd %{_builddir}/hatchling-0.24.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651522798
...
cp %{_builddir}/hatchling-0.24.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
