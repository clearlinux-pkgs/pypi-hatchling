...
Source0  : https://files.pythonhosted.org/packages/db/3a/704067749349cb0d034573d81fd1e61664a65017820e1c83278f2467338e/hatchling-0.23.0.tar.gz
...
%prep
%setup -q -n hatchling-0.23.0
cd %{_builddir}/hatchling-0.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651150609
...
cp %{_builddir}/hatchling-0.23.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
