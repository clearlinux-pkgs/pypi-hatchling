...
Source0  : https://files.pythonhosted.org/packages/69/aa/a545bcbb63ca8c8c53b00584450bcc89de282bf1b1c50a150fc6b6f02c82/hatchling-1.6.0.tar.gz
...
%prep
%setup -q -n hatchling-1.6.0
cd %{_builddir}/hatchling-1.6.0
pushd ..
cp -a hatchling-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658764257
