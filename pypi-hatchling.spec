...
Source0  : https://files.pythonhosted.org/packages/0e/7a/bc6679c4c8814b8f09957d255825e75a09220660c272f95719c512538811/hatchling-1.9.0.tar.gz
...
%prep
%setup -q -n hatchling-1.9.0
cd %{_builddir}/hatchling-1.9.0
pushd ..
cp -a hatchling-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662854079
