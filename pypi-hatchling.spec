...
Source0  : https://files.pythonhosted.org/packages/4f/2a/c34d71531d1e1c9a5029bb73eb3816285befd0fffd7c63ffa0544253dca8/hatchling-1.22.4.tar.gz
...
%prep
%setup -q -n hatchling-1.22.4
cd %{_builddir}/hatchling-1.22.4
pushd ..
cp -a hatchling-1.22.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711313309
