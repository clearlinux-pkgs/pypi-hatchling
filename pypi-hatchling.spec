...
Source0  : https://files.pythonhosted.org/packages/83/2d/8fe45dabfdc8630999420fa9439f5dd8138f2a375a41a78f97dd2b7304dc/hatchling-1.5.0.tar.gz
...
%prep
%setup -q -n hatchling-1.5.0
cd %{_builddir}/hatchling-1.5.0
pushd ..
cp -a hatchling-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657552712
...
cp %{_builddir}/hatchling-1.5.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
