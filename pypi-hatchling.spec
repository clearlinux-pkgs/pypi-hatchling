...
Source0  : https://files.pythonhosted.org/packages/40/36/526e71593a2a7464425a00e4d2c90ecc8f71c4de2c8d916f22dd30cb9e6a/hatchling-1.0.0.tar.gz
...
%prep
%setup -q -n hatchling-1.0.0
cd %{_builddir}/hatchling-1.0.0
pushd ..
cp -a hatchling-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653335382
...
cp %{_builddir}/hatchling-1.0.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
