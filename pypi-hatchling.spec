...
Source0  : https://files.pythonhosted.org/packages/51/40/9007232411fdb941d2c517f71476329ed2e967b3e861082df01dda82d917/hatchling-1.4.1.tar.gz
...
%prep
%setup -q -n hatchling-1.4.1
cd %{_builddir}/hatchling-1.4.1
pushd ..
cp -a hatchling-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657035472
...
cp %{_builddir}/hatchling-1.4.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
