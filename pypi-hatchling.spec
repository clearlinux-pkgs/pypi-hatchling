...
Source0  : https://files.pythonhosted.org/packages/58/53/a5957d34c0e7121b97ce164c4b5e0f7e5da54e9071049b77faf8348d1190/hatchling-1.3.0.tar.gz
...
%prep
%setup -q -n hatchling-1.3.0
cd %{_builddir}/hatchling-1.3.0
pushd ..
cp -a hatchling-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653335831
...
cp %{_builddir}/hatchling-1.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hatchling/597acb03a5ab8ad933e0aa297418aa8e6ffe61b2
