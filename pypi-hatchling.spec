...
Source0  : https://files.pythonhosted.org/packages/5b/03/637d28b2a0340a7bdabc305916ee34316cd280faa0133251c48a41b17975/hatchling-1.7.1.tar.gz
...
%prep
%setup -q -n hatchling-1.7.1
cd %{_builddir}/hatchling-1.7.1
pushd ..
cp -a hatchling-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660514499
