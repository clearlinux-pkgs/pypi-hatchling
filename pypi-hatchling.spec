...
Source0  : https://files.pythonhosted.org/packages/a1/e0/e22e343e7e5853b1d10c5f6fb5072ca3d38aa05e51c9920bb373d393e40c/hatchling-1.8.1.tar.gz
...
%prep
%setup -q -n hatchling-1.8.1
cd %{_builddir}/hatchling-1.8.1
pushd ..
cp -a hatchling-1.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661444790
